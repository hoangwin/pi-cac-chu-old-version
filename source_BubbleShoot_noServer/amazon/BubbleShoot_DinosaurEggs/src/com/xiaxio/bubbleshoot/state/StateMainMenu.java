...
public class StateMainMenu extends MainActivity implements IConstant
{
	...
	public static final int MENU_OPTION_SOUND = 1;
	public static final int MENU_RATING = 3;
	//public static final int MENU_CREDIT = 5;
	public static final int MENU_EXIT =2;
	
	public static int[] arrayMenu = { MENU_PUZZLE_MODE, MENU_OPTION_SOUND,MENU_EXIT};
	public static String[] arrayMenuString = {"PLAY GAME","SOUND:","EXIT" };
