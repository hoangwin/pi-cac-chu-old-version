...
import com.xiaxio.bubbleshoot.Sprite;
import com.xiaxio.bubbleshoot.actor.Bubble;
...
public class StateGameplay extends MainActivity
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_CTOR:
			...
			DEF.LABEL_LEVEL_Y = (int)(1030*scaleY);//textBounds.height();//fontsmall_Yellow.getFontHeight();
	...
	public static void drawHUD(Canvas c) 
	{
		...
		android_FontSmall.setColor(Color.rgb(173,73, 66));
		android_FontSmall.setTextAlign(Align.LEFT);
		android_FontSmallBoder.setTextAlign(Align.LEFT);
		if (gameMode == 1)
		{
			c.drawText(  "L." + (mcurrentlevel +1), DEF.LABEL_LEVEL_X, DEF.LABEL_LEVEL_Y,  android_FontSmallBoder);
			c.drawText(  "L." + (mcurrentlevel +1), DEF.LABEL_LEVEL_X, DEF.LABEL_LEVEL_Y,  android_FontSmall);
