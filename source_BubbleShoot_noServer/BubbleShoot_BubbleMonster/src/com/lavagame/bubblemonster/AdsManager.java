...
public class AdsManager {
	...
	public static String UID_ADMOB_STRING = "a152087f65908b0";//kiem tra trong file manifest nua
	public static String UID_INNER_ACTIVE_STRING = "hoangnguyenmau_BubbleMonster_Android";// chi mot cho
