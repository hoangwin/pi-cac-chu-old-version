...
//	public static int offset = -100;
	...
	public static int HOWTOPLAY_BACKGROUND_W = TapPetStory.SCREEN_WIDTH ;
	public static int HOWTOPLAY_BACKGROUND_H = TapPetStory.SCREEN_HEIGHT;
	public static int HOWTOPLAY_BUTTON_W = 93;
	public static int HOWTOPLAY_BUTTON_H = 93;	
	public static int HOWTOPLAY_TITLE_X = TapPetStory.SCREEN_WIDTH/2; 
	...
	public static int CREADIT_BACKGROUND_X = TapPetStory.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_Y = TapPetStory.SCREEN_HEIGHT /6;
	public static int CREADIT_BACKGROUND_W = TapPetStory.SCREEN_WIDTH - 2 * TapPetStory.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_H = TapPetStory.SCREEN_HEIGHT - 2 * TapPetStory.SCREEN_HEIGHT / 8;
	
	public static int CREADIT_TITLE_X = TapPetStory.SCREEN_WIDTH/2; 
	...
	//align OPTION SCREEN
	public static int OPTION_TITLE_X = TapPetStory.SCREEN_WIDTH/2; 
	...
	public static int SELECTLEVEL_BACKGROUND_W = TapPetStory.SCREEN_WIDTH - 20;
	public static int SELECTLEVEL_BACKGROUND_H = TapPetStory.SCREEN_HEIGHT - 20;
	public static int SELECTLEVEL_TITLE_X = TapPetStory.SCREEN_WIDTH/2; 
