...
import com.xiaxio.diamondisland.actor.DiamondActor;
...
public class Map
{
	...
	public static void init()
	{
		...
		ITEM_WIDTH = (int)(110*Diamond.scaleX);//StateGameplay.spriteFruit.getFrameWidth(0);
		ITEM_HEIGHT =(int)(110*Diamond.scaleY);// StateGameplay.spriteFruit.getFrameHeight(0);
