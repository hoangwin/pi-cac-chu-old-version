...
public class StateGameplay extends Diamond
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_CTOR:
			...
			DEF.LABEL_LEVEL_Y = DEF.LABEL_SCORE_Y =(int)(100*scaleY);
	...
	public static void drawHUD(Canvas c)
	{
		...
		if (gameMode == 1)
		{
			...
			mainCanvas.drawText(  " " + Map.mTopScore, DEF.LABEL_SCORE_X, DEF.LABEL_SCORE_Y, android_FontSmall);
		...
		Rect textBounds =  new  Rect();
		android_FontSmall.getTextBounds("Maig", 0, "Maig".length(), textBounds);
		mainCanvas.drawText( text,  SCREEN_WIDTH / 2, DEF.BUTTON_TIMER_BAR_Y + textBounds.height(), android_FontSmallBoder);
