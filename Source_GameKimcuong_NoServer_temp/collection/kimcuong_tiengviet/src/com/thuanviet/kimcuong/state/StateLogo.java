...
public class StateLogo extends Kimcuong implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			case 1:
				...
				break;
			case 2:
				if (Kimcuong.fontbig_White == null)
					Kimcuong.fontbig_White = new BitmapFont("font/white_36.spr", true);				
			...
			case 4:
				...
				SoundManager.initSounds(Kimcuong.context);
			...
			case 10:
				...
				if (StateHowToPlay.bitmapHowToplay == null) {
					StateHowToPlay.bitmapHowToplay = Kimcuong.loadImageFromAsset("image/howtoplay.png");
		...
		case MESSAGE_PAINT:
			...
			Kimcuong.mainPaint.setColor(Color.WHITE);
			Kimcuong.mainPaint.setTextSize(20);
			matrix.reset();
