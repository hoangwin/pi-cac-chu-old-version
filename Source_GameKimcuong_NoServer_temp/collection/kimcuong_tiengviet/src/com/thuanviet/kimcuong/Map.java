...
public class Map
{
	...
	public static void init()
	{
		...
		ITEM_WIDTH = (int)(110*Kimcuong.scaleX);//StateGameplay.spriteFruit.getFrameWidth(0);
		ITEM_HEIGHT =(int)(110*Kimcuong.scaleY);// StateGameplay.spriteFruit.getFrameHeight(0);
		DiamondActor.speed = ITEM_HEIGHT/2;
		BEGIN_X = (Kimcuong.SCREEN_WIDTH - MAX_COL * ITEM_WIDTH) / 2;
	...
	{ 
		...
		case STATE_DROP:
			...
			if (completeState  ) {
				if(!checkCanBreakAnyBlock(3) || effectscore > 150)//reset khi ma khong con o co the tap
				{
					isChangeIndex = true;//
					SoundManager.playSound(SoundManager.SOUND_START, 1);
					timeEffect = 0;
