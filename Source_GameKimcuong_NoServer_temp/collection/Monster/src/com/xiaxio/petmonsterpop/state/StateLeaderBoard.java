...
import com.xiaxio.petmonsterpop.UserInfo;
...
public class StateLeaderBoard extends Monster
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:		
			...
			if (isKeyReleased(KeyEvent.KEYCODE_BACK) || Monster.isTouchReleaseInRect(0, 0, DEF.BUTTON_CANCEL_CONFIRM_W,DEF.BUTTON_CANCEL_CONFIRM_H))
		...
		//	mainCanvas.drawText(" "+(UserInfo.myUserInfo.level),LEVEL_X,(int)( Begin_Y +  (1 + (6 +2)*1.5)*textBoundsNormal.height()), android_FontNormal);
			...
			if (Monster.isTouchDrapInRect(0, 0, DEF.BUTTON_CANCEL_CONFIRM_W, DEF.BUTTON_CANCEL_CONFIRM_H))
				StateGameplay.spriteDPad.drawAFrame(Monster.mainCanvas, DEF.FRAME_CANCEL_HIGHTLIGHT, 0, 0);
			else
				StateGameplay.spriteDPad.drawAFrame(Monster.mainCanvas, DEF.FRAME_CANCEL_NORMAL, 0, 0);
