...
public class StateLogo extends Monster implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			case 1:
				...
				break;
			case 2:
				if (Monster.fontbig_White == null)
					Monster.fontbig_White = new BitmapFont("font/white_36.spr", true);				
			...
			case 4:
				...
				SoundManager.initSounds(Monster.context);
		...
		case MESSAGE_PAINT:
			...
			Monster.mainPaint.setColor(Color.WHITE);
			Monster.mainPaint.setTextSize(20);
			matrix.reset();
