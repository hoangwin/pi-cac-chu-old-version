...
public class StateHint extends Monster
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			Monster.mainCanvas.drawRoundRect(rectF, 25, 25, Monster.mainPaint);
			Rect textBounds =  new  Rect();
			Monster.spriteUI.drawAFrame(mainCanvas, 0,HINT_X, HINT_Y);
