...
{	
	...
	public static synchronized void SendMessage(int type) {
		...
		case MESSAGE_PAINT:
			...
			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, "Game Nino", DEF.CREADIT_CONTENT_X, DEF.CREADIT_CONTENT_Y + 2*DEF.CREADIT_CONTENT_SPACE_H,  BitmapFont.ALIGN_CENTER);
			...
			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, "Caogia", DEF.CREADIT_CONTENT_X, DEF.CREADIT_CONTENT_Y + 4*DEF.CREADIT_CONTENT_SPACE_H, DEF.CREADIT_BACKGROUND_W - 60, BitmapFont.ALIGN_CENTER);
