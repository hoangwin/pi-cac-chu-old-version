...
public class StateLeaderBoard extends Diamond
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			if (mPreState == STATE_MAINMENU) {
				if (isKeyReleased(KeyEvent.KEYCODE_BACK) || Diamond.isTouchReleaseInRect(DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
		...
		case MESSAGE_PAINT:
			...
			Diamond.mainCanvas.drawBitmap(rankBackground, matrix, Diamond.mainPaint);

			//draw text

			

			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, "RANK", WINLOSE_CONTENT_X - WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y, BitmapFont.ALIGN_LEFT);
			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, "SCORE", WINLOSE_CONTENT_X + WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y, BitmapFont.ALIGN_RIGHT);

			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, "===================", WINLOSE_CONTENT_X - WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y + RANK_ELEMENT_H, BitmapFont.ALIGN_LEFT);

			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, "1:" + user1, WINLOSE_CONTENT_X - WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y + 2 * RANK_ELEMENT_H, BitmapFont.ALIGN_LEFT);
			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, " " + score1, WINLOSE_CONTENT_X + WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y + 2 * RANK_ELEMENT_H, BitmapFont.ALIGN_RIGHT);

			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, "2:" + user2, WINLOSE_CONTENT_X - WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y + 3 * RANK_ELEMENT_H, BitmapFont.ALIGN_LEFT);
			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, " " + score2, WINLOSE_CONTENT_X + WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y + 3 * RANK_ELEMENT_H, BitmapFont.ALIGN_RIGHT);

			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, "3:" + user3, WINLOSE_CONTENT_X - WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y + 4 * RANK_ELEMENT_H, BitmapFont.ALIGN_LEFT);
			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, " " + score3, WINLOSE_CONTENT_X + WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y + 4 * RANK_ELEMENT_H, BitmapFont.ALIGN_RIGHT);

			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, "4:" + user4, WINLOSE_CONTENT_X - WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y + 5 * RANK_ELEMENT_H, BitmapFont.ALIGN_LEFT);
			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, " " + score4, WINLOSE_CONTENT_X + WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y + 5 * RANK_ELEMENT_H, BitmapFont.ALIGN_RIGHT);

			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, "5:" + user5, WINLOSE_CONTENT_X - WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y + 6 * RANK_ELEMENT_H, BitmapFont.ALIGN_LEFT);
			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, " " + score5, WINLOSE_CONTENT_X + WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y + 6 * RANK_ELEMENT_H, BitmapFont.ALIGN_RIGHT);

			Diamond.fontsmall_White.drawString(Diamond.mainCanvas, "==================", WINLOSE_CONTENT_X - WINLOSE_CONTENT_SPACE_W, RANK_BEGIN_Y + 7 * RANK_ELEMENT_H, BitmapFont.ALIGN_LEFT);
			...
			if (mPreState == STATE_MAINMENU) {
				if (!Diamond.isTouchDrapInRect(DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
					StateGameplay.spriteDPad.drawAFrame(Diamond.mainCanvas, DEF.FRAME_OK_NORMAL, DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1);
				else
					StateGameplay.spriteDPad.drawAFrame(Diamond.mainCanvas, DEF.FRAME_OK_HIGHTLIGHT, DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1);
			} else {
				if (!Diamond.isTouchDrapInRect(DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
