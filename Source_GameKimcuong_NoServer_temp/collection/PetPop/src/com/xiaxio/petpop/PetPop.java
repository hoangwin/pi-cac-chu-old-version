...
import com.xiaxio.petpop.state.StateCreadit;
import com.xiaxio.petpop.state.StateGameplay;
import com.xiaxio.petpop.state.StateHint;
import com.xiaxio.petpop.state.StateHowToPlay;
import com.xiaxio.petpop.state.StateIngameMenu;
import com.xiaxio.petpop.state.StateLeaderBoard;
import com.xiaxio.petpop.state.StateLogo;
import com.xiaxio.petpop.state.StateMainMenu;
import com.xiaxio.petpop.state.StateSelectLevel;
...
public class PetPop extends GameLib
{
	...
	public static PetPop mainActivity;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		String UID = "a151dc031b9f25b";//hoang.nguyenmau@hotmail.com
	...
	{
		String username = PetPop.mainActivity.getUsername();
		SharedPreferences settings = getSharedPreferences(SAVE_REF, 0);
		mLevelUnlock = settings.getInt(LEVEL_UNLOCK,0);
		if (username != null && username.length() > 1)
			PetPop.UserName = username;
		else
