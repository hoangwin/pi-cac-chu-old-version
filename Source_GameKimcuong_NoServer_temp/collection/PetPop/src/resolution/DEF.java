...
public class DEF
{
	...
	public static int FRAME_BACK_NORMAL = 2;
	public static int FRAME_BACK_HIGHTLIGHT = 3;
	public static int FRAME_RATING_NORMAL = 4;
	public static int FRAME_RATING_HIGHTLIGHT = 5;	
	...
	public static int FRAME_INFO_NORMAL = 35; 
	public static int FRAME_INFO_HIGHTLIGHT = 36;
...
//	public static int offset = -100;
	...
	public static int HOWTOPLAY_BACKGROUND_W = PetPop.SCREEN_WIDTH ;
	public static int HOWTOPLAY_BACKGROUND_H = PetPop.SCREEN_HEIGHT;
	public static int HOWTOPLAY_BUTTON_W = 93;
	public static int HOWTOPLAY_BUTTON_H = 93;	
	public static int HOWTOPLAY_TITLE_X = PetPop.SCREEN_WIDTH/2; 
	...
	public static int CREADIT_BACKGROUND_X = PetPop.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_Y = PetPop.SCREEN_HEIGHT /6;
	public static int CREADIT_BACKGROUND_W = PetPop.SCREEN_WIDTH - 2 * PetPop.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_H = PetPop.SCREEN_HEIGHT - 2 * PetPop.SCREEN_HEIGHT / 8;
	
	public static int CREADIT_TITLE_X = PetPop.SCREEN_WIDTH/2; 
	...
	//align OPTION SCREEN
	public static int OPTION_TITLE_X = PetPop.SCREEN_WIDTH/2; 
	...
	public static int SELECTLEVEL_BACKGROUND_W = PetPop.SCREEN_WIDTH - 20;
	public static int SELECTLEVEL_BACKGROUND_H = PetPop.SCREEN_HEIGHT - 20;
	public static int SELECTLEVEL_TITLE_X = PetPop.SCREEN_WIDTH/2; 
