...
public class Dialog
{
	...
	public static void drawDialog(Canvas c)
	{
		...
		Diamond.android_FontNormal.getTextBounds("Maig", 0, "Maig".length(), textBounds);		
		Diamond.mainCanvas.drawText( dialogText , Diamond.SCREEN_WIDTH / 2,   DIALOG_CONFIRM_Y+ textBounds.height()*3 ,Diamond.android_FontNormal);
		...
		int x2 =  Diamond.SCREEN_WIDTH - DIALOG_CONFIRM_X - DIALOG_CONFIRM_W/4 - DEF.DIALOG_BUTTON_CONFIRM_W ;
		//draw button
		switch (dialogType)
		{
