...
public class StateMainMenu extends Diamond implements IConstant
{
	...
	public static int[] arrayMenu = { MENU_NORMAL_MODE, MENU_TIME_TRIAL_MODE, MENU_RATING };
	public static String[] arrayMenuString = { "QUICKPLAY", "CLASSIC", "RATING" };
		...
		case MESSAGE_UPDATE:
			...
			for (int i = 0; i < arrayMenu.length; i++) {
				...
				//		break;
					case MENU_RATING:
						try {
							Uri uri = Uri.parse("https://play.google.com/store/apps/details?id=com.xiaxio.diamondisland");
