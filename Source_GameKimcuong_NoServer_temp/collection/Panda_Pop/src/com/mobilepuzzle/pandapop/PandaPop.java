...
import com.mobilepuzzle.pandapop.state.StateCreadit;
import com.mobilepuzzle.pandapop.state.StateGameplay;
import com.mobilepuzzle.pandapop.state.StateHint;
import com.mobilepuzzle.pandapop.state.StateHowToPlay;
import com.mobilepuzzle.pandapop.state.StateIngameMenu;
import com.mobilepuzzle.pandapop.state.StateLeaderBoard;
import com.mobilepuzzle.pandapop.state.StateLogo;
import com.mobilepuzzle.pandapop.state.StateMainMenu;
import com.mobilepuzzle.pandapop.state.StateSelectLevel;
import com.mobilepuzzle.pandapop.state.StateWinLose;
...
public class PandaPop extends GameLib
{
	...
	public static PandaPop mainActivity;
	...
	{
		String username = PandaPop.mainActivity.getUsername();
		SharedPreferences settings = getSharedPreferences(SAVE_REF, 0);
		mLevelUnlock = settings.getInt(LEVEL_UNLOCK,0);
		if (username != null && username.length() > 1)
			PandaPop.UserName = username;
		else
