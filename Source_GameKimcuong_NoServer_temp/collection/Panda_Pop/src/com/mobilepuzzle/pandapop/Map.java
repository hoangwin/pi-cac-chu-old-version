...
public class Map
{
	...
	public static void init()
	{
		...
		DiamondActor.speed = ITEM_HEIGHT/3;
		BEGIN_X = (PandaPop.SCREEN_WIDTH - MAX_COL * ITEM_WIDTH) / 2;
		BEGIN_Y = (int) (176 * StateGameplay.SCREEN_HEIGHT * 1.0f / 1280);
	...
	public static void DrawGame(Canvas c)
	{
		...
		case STATE_IDE:
			...
			if(timeEffect++ < TIME_WAIT_TO_DROP){
				c.drawText(strEffect, effectScore_X, effectScore_Y, StateGameplay.android_FontBigBoder);
	...
	{ 
		...
		if (stateGame == 1)//dang play game
			Map.timer += GameViewThread.timeCurrent - GameViewThread.timePrev;
