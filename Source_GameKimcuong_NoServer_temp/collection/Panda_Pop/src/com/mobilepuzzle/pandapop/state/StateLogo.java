...
public class StateLogo extends PandaPop implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			case 1:
				...
				break;
			case 2:
				if (PandaPop.fontbig_White == null)
					PandaPop.fontbig_White = new BitmapFont("font/white_36.spr", true);				
			...
			case 4:
				...
				SoundManager.initSounds(PandaPop.context);
		...
		case MESSAGE_PAINT:
			...
			PandaPop.mainPaint.setColor(Color.WHITE);
			PandaPop.mainPaint.setTextSize(20);
			matrix.reset();
