...
import com.mobilepuzzle.pandapop.Sprite;
...
public class StateGameplay extends PandaPop
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			if (isKeyReleased(KeyEvent.KEYCODE_9)) {
				...
				PandaPop.changeState(IConstant.STATE_WINLOSE);
	...
	public static void drawHUD(Canvas c)
	{
		...
		if (isTouchDrapInRect(DEF.BUTTON_IGM_X, DEF.BUTTON_IGM_Y, DEF.BUTTON_IGM_W, DEF.BUTTON_IGM_H))
			spriteDPad.drawAFrame(PandaPop.mainCanvas, DEF.FRAME_PAUSE_HIGHTLIGHT, DEF.BUTTON_IGM_X, DEF.BUTTON_IGM_Y);
		else
			spriteDPad.drawAFrame(PandaPop.mainCanvas, DEF.FRAME_PAUSE_NORMAL, DEF.BUTTON_IGM_X, DEF.BUTTON_IGM_Y);
		...
		//timer bar		
		spriteDPad.drawAFrame(PandaPop.mainCanvas, DEF.FRAME_TIMER_BAR_0, DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y);
		...
		PandaPop.mainCanvas.save();
		PandaPop.mainCanvas.clipRect(DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y, DEF.BUTTON_TIMER_BAR_X + (int) width, DEF.BUTTON_TIMER_BAR_Y + 32);
		spriteDPad.drawAFrame(PandaPop.mainCanvas, DEF.FRAME_TIMER_BAR_1, DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y);
		PandaPop.mainCanvas.restore();
		Rect textBounds =  new  Rect();
		android_FontSmall.getTextBounds("Maig", 0, "Maig".length(), textBounds);
