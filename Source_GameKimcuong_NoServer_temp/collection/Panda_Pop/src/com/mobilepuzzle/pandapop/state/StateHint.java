...
import com.mobilepuzzle.pandapop.GameViewThread;
...
public class StateHint extends PandaPop
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			PandaPop.mainPaint.setStyle(Style.FILL);
			PandaPop.mainPaint.setARGB(150, 0, 0, 0);
			PandaPop.mainCanvas.drawRect(0, 0, PandaPop.SCREEN_WIDTH, PandaPop.SCREEN_HEIGHT, PandaPop.mainPaint);
			PandaPop.mainPaint.setStyle(Style.FILL_AND_STROKE);
			PandaPop.mainPaint.setColor(Color.argb(170,128, 194, 32));
			PandaPop.mainCanvas.drawRoundRect(rectF, 25, 25, PandaPop.mainPaint);
			Rect textBounds =  new  Rect();
			PandaPop.spriteUI.drawAFrame(mainCanvas, 0,HINT_X, HINT_Y);
