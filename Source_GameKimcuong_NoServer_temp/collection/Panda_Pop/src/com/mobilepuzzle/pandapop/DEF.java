...
//	public static int offset = -100;
	...
	public static int HOWTOPLAY_BACKGROUND_W = PandaPop.SCREEN_WIDTH ;
	public static int HOWTOPLAY_BACKGROUND_H = PandaPop.SCREEN_HEIGHT;
	public static int HOWTOPLAY_BUTTON_W = 93;
	public static int HOWTOPLAY_BUTTON_H = 93;	
	public static int HOWTOPLAY_TITLE_X = PandaPop.SCREEN_WIDTH/2; 
	...
	public static int CREADIT_BACKGROUND_X = PandaPop.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_Y = PandaPop.SCREEN_HEIGHT /6;
	public static int CREADIT_BACKGROUND_W = PandaPop.SCREEN_WIDTH - 2 * PandaPop.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_H = PandaPop.SCREEN_HEIGHT - 2 * PandaPop.SCREEN_HEIGHT / 8;
	
	public static int CREADIT_TITLE_X = PandaPop.SCREEN_WIDTH/2; 
	...
	//align OPTION SCREEN
	public static int OPTION_TITLE_X = PandaPop.SCREEN_WIDTH/2; 
	...
	public static int SELECTLEVEL_BACKGROUND_W = PandaPop.SCREEN_WIDTH - 20;
	public static int SELECTLEVEL_BACKGROUND_H = PandaPop.SCREEN_HEIGHT - 20;
	public static int SELECTLEVEL_TITLE_X = PandaPop.SCREEN_WIDTH/2; 
