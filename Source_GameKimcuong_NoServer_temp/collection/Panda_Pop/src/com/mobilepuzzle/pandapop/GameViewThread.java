			...
			while (PandaPop.running) {
				//FRAME_RATE_CURRENT = 1000/(timeCurrent - timePrev)
					...
					if(GameLib.mainCanvas != null && holder != null)
					{
						...
						PandaPop.SendMessage(PandaPop.mCurrentState,PandaPop.MESSAGE_PAINT);
						holder.unlockCanvasAndPost(GameLib.mainCanvas);
						PandaPop.SendMessage(PandaPop.mCurrentState,PandaPop.MESSAGE_UPDATE);
						PandaPop.UpdateKey();					
						PandaPop.UpdateTouch();
						timePrev2 = timePrev;
						timePrev = timeCurrent;
