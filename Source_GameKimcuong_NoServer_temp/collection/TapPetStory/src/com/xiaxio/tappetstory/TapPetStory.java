...
import com.xiaxio.tappetstory.state.StateCreadit;
import com.xiaxio.tappetstory.state.StateGameplay;
import com.xiaxio.tappetstory.state.StateHint;
import com.xiaxio.tappetstory.state.StateHowToPlay;
import com.xiaxio.tappetstory.state.StateIngameMenu;
import com.xiaxio.tappetstory.state.StateLeaderBoard;
import com.xiaxio.tappetstory.state.StateLogo;
import com.xiaxio.tappetstory.state.StateMainMenu;
import com.xiaxio.tappetstory.state.StateSelectLevel;
import com.xiaxio.tappetstory.state.StateWinLose;
...
public class TapPetStory extends GameLib
{
	...
	public static TapPetStory mainActivity;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		String UID = "a151c658d6ea805";//haongcaogia pet saga crushing		
	...
	{
		String username = TapPetStory.mainActivity.getUsername();
		SharedPreferences settings = getSharedPreferences(SAVE_REF, 0);
		mLevelUnlock = settings.getInt(LEVEL_UNLOCK,0);
		if (username != null && username.length() > 1)
			TapPetStory.UserName = username;
		else
