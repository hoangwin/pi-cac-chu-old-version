...
public class StateHint extends TapPetStory
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			TapPetStory.mainPaint.setStyle(Style.FILL);
			TapPetStory.mainPaint.setARGB(150, 0, 0, 0);
			...
			TapPetStory.mainCanvas.drawRoundRect(rectF, 25, 25, TapPetStory.mainPaint);
