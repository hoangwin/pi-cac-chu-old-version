...
public class StateLogo extends TapPetStory implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			{
			case 1:
			if (TapPetStory.fontbig_White == null)
					TapPetStory.fontbig_White = new BitmapFont("font/white_36.spr", true);	
				Typeface face;
			...
			case 2:
				...
				SoundManager.initSounds(TapPetStory.context);
			...
			case 5:
				...
				if (StateHowToPlay.bitmapHowToplay == null) {
					StateHowToPlay.bitmapHowToplay = TapPetStory.loadImageFromAsset("image/howtoplay.png");
				}
				break;
		...
		case MESSAGE_PAINT:
			...
			TapPetStory.mainPaint.setColor(Color.WHITE);
			TapPetStory.mainPaint.setTextSize(20);
			matrix.reset();
