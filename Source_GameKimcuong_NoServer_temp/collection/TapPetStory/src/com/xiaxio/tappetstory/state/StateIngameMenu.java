...
public class StateIngameMenu extends TapPetStory implements IConstant
{
			...
			for (int i = 0; i < arrayMenu.length; i++) {
				...
				if (isTouchReleaseInRect(MENU_BEGIN_X - MENU_ELEMENT_W / 2, y - MENU_ELEMENT_H / 2, MENU_ELEMENT_W, MENU_ELEMENT_H)) {
					...
					case MENU_RESUME:
						...
						break;
					case MENU_RESTART:
						Dialog.showDialog(Dialog.DIALOG_TYPE_CONFIRM, "", "Eestart game?", Dialog.DIALOG_RESTART_GAME);
						break;
