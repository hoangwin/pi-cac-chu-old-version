...
public class UserInfo {
	...
	public static  String getUsername()
	{
		...
		//Account[] accounts = AccountManager.get(TapPetStory.mainGameLib).getAccounts();
		
		AccountManager manager = AccountManager.get(TapPetStory.mainGameLib); 
	...
	{		
		UserInfo.myUserInfo.score= 0;//Map.mTopScore;
