...
public class StateLogo extends DiamondTemple implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			case 1:
				...
				break;
			case 2:
				if (DiamondTemple.fontbig_White == null)
					DiamondTemple.fontbig_White = new BitmapFont("font/white_36.spr", true);				
			...
			case 4:
				...
				SoundManager.initSounds(DiamondTemple.context);
