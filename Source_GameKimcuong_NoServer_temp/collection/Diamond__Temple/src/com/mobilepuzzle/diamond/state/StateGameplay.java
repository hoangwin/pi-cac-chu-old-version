...
import com.mobilepuzzle.diamond.Sprite;
...
public class StateGameplay extends DiamondTemple
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			if (isKeyReleased(KeyEvent.KEYCODE_9)) {
				...
				DiamondTemple.changeState(IConstant.STATE_WINLOSE);
	...
	public static void drawHUD(Canvas c)
	{
		...
		if (gameMode == 1)
		{
			mainCanvas.drawText(  "Level : " + (mcurrentlevel +1), DEF.LABEL_LEVEL_X, DEF.LABEL_LEVEL_Y,  android_FontSmall);
			mainCanvas.drawText(  "Score : " + Map.score, DEF.LABEL_SCORE_X, DEF.LABEL_SCORE_Y, android_FontSmall);
		}	//fontsmall_White.drawString(mainCanvas, "Level : " + (mcurrentlevel +1), DEF.LABEL_LEVEL_X, DEF.LABEL_LEVEL_Y, BitmapFont.ALIGN_LEFT);
		else if (gameMode == 0) 
			mainCanvas.drawText(  "Score : " + Map.score, DEF.LABEL_SCORE_X, DEF.LABEL_SCORE_Y, android_FontSmall);
		else
			mainCanvas.drawText(  "Score : " + Map.mTopScore, DEF.LABEL_SCORE_X, DEF.LABEL_SCORE_Y, android_FontSmall);
		...
		if (isTouchDrapInRect(DEF.BUTTON_IGM_X, DEF.BUTTON_IGM_Y, DEF.BUTTON_IGM_W, DEF.BUTTON_IGM_H))
			spriteDPad.drawAFrame(DiamondTemple.mainCanvas, DEF.FRAME_PAUSE_HIGHTLIGHT, DEF.BUTTON_IGM_X, DEF.BUTTON_IGM_Y);
		else
			spriteDPad.drawAFrame(DiamondTemple.mainCanvas, DEF.FRAME_PAUSE_NORMAL, DEF.BUTTON_IGM_X, DEF.BUTTON_IGM_Y);
		...
		//timer bar		
		spriteDPad.drawAFrame(DiamondTemple.mainCanvas, DEF.FRAME_TIMER_BAR_0, DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y);
		...
		DiamondTemple.mainCanvas.save();
		DiamondTemple.mainCanvas.clipRect(DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y, DEF.BUTTON_TIMER_BAR_X + (int) width, DEF.BUTTON_TIMER_BAR_Y + 32);
		spriteDPad.drawAFrame(DiamondTemple.mainCanvas, DEF.FRAME_TIMER_BAR_1, DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y);
		DiamondTemple.mainCanvas.restore();
		Rect textBounds =  new  Rect();
		android_FontSmall.getTextBounds("Maig", 0, "Maig".length(), textBounds);
