...
public class Dialog
{
	...
	public static int DIALOG_CONFIRM_Y = DiamondTemple.SCREEN_HEIGHT / 4;
	public static int DIALOG_CONFIRM_W = DiamondTemple.SCREEN_WIDTH - 2 * DiamondTemple.SCREEN_WIDTH /20;
	public static int DIALOG_CONFIRM_H = (int)(653*DiamondTemple.scaleY);
	...
	public static void drawDialog(Canvas c)
	{
		...
		DiamondTemple.spriteUI.drawAFrame(c, 0, DIALOG_CONFIRM_X, DIALOG_CONFIRM_Y);
		
		
		//draw text
		Rect textBounds =  new  Rect();
		DiamondTemple.android_FontNormal.getTextBounds("Maig", 0, "Maig".length(), textBounds);		
		DiamondTemple.mainCanvas.drawText( dialogText , DiamondTemple.SCREEN_WIDTH / 2,   DIALOG_CONFIRM_Y+ textBounds.height()*3 ,DiamondTemple.android_FontNormal);
		...
		int x2 =  DiamondTemple.SCREEN_WIDTH - DIALOG_CONFIRM_X - DIALOG_CONFIRM_W/4 - DEF.DIALOG_BUTTON_CONFIRM_W ;
		//draw button
		switch (dialogType)
		{
		case DIALOG_TYPE_CONFIRM:

			if (DiamondTemple.isTouchDrapInRect(x1, y , DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
				StateGameplay.spriteDPad.drawAFrame(DiamondTemple.mainCanvas, DEF.FRAME_CANCEL_HIGHTLIGHT, x1, y);
			else
				StateGameplay.spriteDPad.drawAFrame(DiamondTemple.mainCanvas, DEF.FRAME_CANCEL_NORMAL, x1, y);

			if (DiamondTemple.isTouchDrapInRect(x2, y , DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
			   
				StateGameplay.spriteDPad.drawAFrame(DiamondTemple.mainCanvas, DEF.FRAME_OK_HIGHTLIGHT, x2, y);
			else
				StateGameplay.spriteDPad.drawAFrame(DiamondTemple.mainCanvas, DEF.FRAME_OK_NORMAL, x2, y);
			break;
	...
	public static void updateDialog()
	{
		...
		case DIALOG_TYPE_CONFIRM:
			...
			if (DiamondTemple.isTouchReleaseInRect(x1 , y , DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))//cancel
			{
				hideDialog();
			} else if (DiamondTemple.isTouchReleaseInRect(x2 , y , DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))//ok
			{
				Dialog.hideDialog();
				...
				case DIALOG_NEXTSTATE_EXIT:
					...
					DiamondTemple.mainActivity.finish();
					break;
				case DIALOG_BACK_TO_MAINMENU_EXIT:
					DiamondTemple.mainActivity.saveGame();
					DiamondTemple.changeState(DiamondTemple.STATE_MAINMENU, true, true);
					break;
				case DIALOG_RESTART_GAME:
					DiamondTemple.changeState(DiamondTemple.STATE_GAMEPLAY, true, true);
				break;
				default:
					break;
				}
			...
			break;
		case DIALOG_TYPE_NOTICE:
			if (DiamondTemple.isTouchReleaseInRect(x2 , y , DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))//ok
			{
				switch (dialogNextState)
				{
				case DIALOG_NEXTSTATE_CLOSE_LEADERBOARD_DIALOG:
					hideDialog();
					DiamondTemple.changeState(DiamondTemple.mPreState);
					break;
				//case DIALOG_BACK_TO_MAINMENU_EXIT:
				//	break;
