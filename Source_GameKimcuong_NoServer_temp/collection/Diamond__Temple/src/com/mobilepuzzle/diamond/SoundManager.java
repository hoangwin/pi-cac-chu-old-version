...
import com.mobilepuzzle.diamond.R;
...
public class SoundManager {
	...
	private static Context mContext;
	 ...
	 public static int SOUND_COMBOL_4 = 7;
	 public static int SOUND_WIN = 8;
	 public static int SOUND_LOSE = 9;
	 public static int SOUND_BACK = 10;
	 public static int SOUND_SPECIAL_EFFECT_1 = 11;
	 public static int SOUND_SPECIAL_EFFECT_2 = 12;
	 public static int SOUND_SPECIAL_EFFECT_3 = 13;
	 public static int SOUND_START = 14;
	...
	public static  void initSounds(Context theContext)
	{
	    ...
	    // mMediaPlayer = new MediaPlayer();	     
	     ...
	     try {
	    	 ...
	    	 mMediaPlayer[0] = MediaPlayer.create(DiamondTemple.context,R.raw.bg_music);
	    	 mMediaPlayer[0].setVolume(0.9f, 0.9f);
	...
	{
		if(!DiamondTemple.isEnableSound)
			return;
	...
	{	
		...
		mSoundPoolMap.put(SOUND_COMBOL_4, mSoundPool.load(mContext,R.raw.combo_4, 1));
		...
		mSoundPoolMap.put(SOUND_SPECIAL_EFFECT_1, mSoundPool.load(mContext, R.raw.special_effect_1, 1));
		mSoundPoolMap.put(SOUND_SPECIAL_EFFECT_2, mSoundPool.load(mContext, R.raw.special_effect_2, 1));
		mSoundPoolMap.put(SOUND_SPECIAL_EFFECT_3, mSoundPool.load(mContext, R.raw.special_effect_3, 1));
