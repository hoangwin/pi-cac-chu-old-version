...
import com.mobilepuzzle.fruitpop.GameViewThread;
...
public class StateHint extends FruitPop
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			FruitPop.mainPaint.setStyle(Style.FILL);
			FruitPop.mainPaint.setARGB(150, 0, 0, 0);
			FruitPop.mainCanvas.drawRect(0, 0, FruitPop.SCREEN_WIDTH, FruitPop.SCREEN_HEIGHT, FruitPop.mainPaint);
			FruitPop.mainPaint.setStyle(Style.FILL_AND_STROKE);
			FruitPop.mainPaint.setColor(Color.argb(170,128, 194, 32));
			FruitPop.mainCanvas.drawRoundRect(rectF, 25, 25, FruitPop.mainPaint);
			Rect textBounds =  new  Rect();
			FruitPop.spriteUI.drawAFrame(mainCanvas, 0,HINT_X, HINT_Y);
