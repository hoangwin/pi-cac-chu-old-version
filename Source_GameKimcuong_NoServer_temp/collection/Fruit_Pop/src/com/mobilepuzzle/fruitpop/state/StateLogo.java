...
public class StateLogo extends FruitPop implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			case 1:
				...
				break;
			case 2:
				if (FruitPop.fontbig_White == null)
					FruitPop.fontbig_White = new BitmapFont("font/white_36.spr", true);				
			...
			case 4:
				...
				SoundManager.initSounds(FruitPop.context);
		...
		case MESSAGE_PAINT:
			...
			FruitPop.mainPaint.setColor(Color.WHITE);
			FruitPop.mainPaint.setTextSize(20);
			matrix.reset();
