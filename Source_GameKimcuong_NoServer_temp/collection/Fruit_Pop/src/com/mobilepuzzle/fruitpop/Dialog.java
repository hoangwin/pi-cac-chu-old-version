...
public class Dialog
{
	...
	public static int DIALOG_CONFIRM_Y = FruitPop.SCREEN_HEIGHT / 4;
	public static int DIALOG_CONFIRM_W = FruitPop.SCREEN_WIDTH - 2 * FruitPop.SCREEN_WIDTH /20;
	public static int DIALOG_CONFIRM_H = (int)(653*FruitPop.scaleY);
	...
	public static void drawDialog(Canvas c)
	{
		...
		FruitPop.spriteUI.drawAFrame(c, 0, DIALOG_CONFIRM_X, DIALOG_CONFIRM_Y);
		
		
		//draw text
		Rect textBounds =  new  Rect();
		FruitPop.android_FontNormal.getTextBounds("Maig", 0, "Maig".length(), textBounds);		
		FruitPop.mainCanvas.drawText( dialogText , FruitPop.SCREEN_WIDTH / 2,   DIALOG_CONFIRM_Y+ textBounds.height()*3 ,FruitPop.android_FontNormal);
		...
		int x2 =  FruitPop.SCREEN_WIDTH - DIALOG_CONFIRM_X - DIALOG_CONFIRM_W/4 - DEF.DIALOG_BUTTON_CONFIRM_W ;
		//draw button
		switch (dialogType)
		{
		case DIALOG_TYPE_CONFIRM:

			if (FruitPop.isTouchDrapInRect(x1, y , DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
				StateGameplay.spriteDPad.drawAFrame(FruitPop.mainCanvas, DEF.FRAME_CANCEL_HIGHTLIGHT, x1, y);
			else
				StateGameplay.spriteDPad.drawAFrame(FruitPop.mainCanvas, DEF.FRAME_CANCEL_NORMAL, x1, y);

			if (FruitPop.isTouchDrapInRect(x2, y , DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
			   
				StateGameplay.spriteDPad.drawAFrame(FruitPop.mainCanvas, DEF.FRAME_OK_HIGHTLIGHT, x2, y);
			else
				StateGameplay.spriteDPad.drawAFrame(FruitPop.mainCanvas, DEF.FRAME_OK_NORMAL, x2, y);
			break;
	...
	public static void updateDialog()
	{
		...
		case DIALOG_TYPE_CONFIRM:
			...
			if (FruitPop.isTouchReleaseInRect(x1 , y , DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))//cancel
			{
				hideDialog();
			} else if (FruitPop.isTouchReleaseInRect(x2 , y , DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))//ok
			{
				Dialog.hideDialog();
				...
				case DIALOG_NEXTSTATE_EXIT:
					...
					FruitPop.mainActivity.finish();
					break;
				case DIALOG_BACK_TO_MAINMENU_EXIT:
					FruitPop.mainActivity.saveGame();
					FruitPop.changeState(FruitPop.STATE_MAINMENU, true, true);
					break;
				case DIALOG_RESTART_GAME:
					FruitPop.changeState(FruitPop.STATE_GAMEPLAY, true, true);
				break;
				default:
					break;
				}
			...
			break;
		case DIALOG_TYPE_NOTICE:
			if (FruitPop.isTouchReleaseInRect(x2 , y , DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))//ok
			{
				switch (dialogNextState)
				{
				case DIALOG_NEXTSTATE_CLOSE_LEADERBOARD_DIALOG:
					hideDialog();
					FruitPop.changeState(FruitPop.mPreState);
					break;
				//case DIALOG_BACK_TO_MAINMENU_EXIT:
				//	break;
