		...
		int miliSeccondInframe =  1000 / FRAME_RATE_TARGET;
			while (FruitPop.running) {
				...
				//FRAME_RATE_CURRENT = 1000/(timeCurrent - timePrev)
					...
					{
						FruitPop.SendMessage(FruitPop.mCurrentState,FruitPop.MESSAGE_PAINT);	holder.unlockCanvasAndPost(GameLib.mainCanvas);
						FruitPop.SendMessage(FruitPop.mCurrentState,FruitPop.MESSAGE_UPDATE);
						FruitPop.UpdateKey();					
						FruitPop.UpdateTouch();
						timePrev2 = timePrev;
						timePrev = timeCurrent;
