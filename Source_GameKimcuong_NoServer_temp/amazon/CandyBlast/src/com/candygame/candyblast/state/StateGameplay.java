...
import com.candygame.candyblast.actor.DiamondActor;
...
public class StateGameplay extends CandyPop
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			if (isKeyReleased(KeyEvent.KEYCODE_9)) {
				...
				CandyPop.changeState(IConstant.STATE_WINLOSE);
	...
	public static void drawHUD(Canvas c) 
	{
		...
		CandyPop.mainCanvas.save();
		CandyPop.mainCanvas.clipRect(DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y, DEF.BUTTON_TIMER_BAR_X + (int) width, DEF.BUTTON_TIMER_BAR_Y + 32);
		spriteDPad.drawAFrame(CandyPop.mainCanvas, DEF.FRAME_TIMER_BAR_1, DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y);
		CandyPop.mainCanvas.restore();
		Rect textBounds =  new  Rect();
		android_FontSmall.getTextBounds("Maig", 0, "Maig".length(), textBounds);
