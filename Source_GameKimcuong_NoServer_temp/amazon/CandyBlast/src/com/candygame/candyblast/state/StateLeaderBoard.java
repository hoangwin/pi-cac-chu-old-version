...
import com.candygame.candyblast.UserInfo;
...
public class StateLeaderBoard extends CandyPop
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:		
			...
			if (isKeyReleased(KeyEvent.KEYCODE_BACK) || CandyPop.isTouchReleaseInRect(0, 0, DEF.BUTTON_CANCEL_CONFIRM_W,DEF.BUTTON_CANCEL_CONFIRM_H))
		...
		case MESSAGE_PAINT:
			...
			int Begin_Title_X = (int)(400* scaleX);
			int Begin_Y = (int)(300* scaleY);
			...
			//---------------------------------------
			mainCanvas.drawText( "LEADERBOARD", Begin_Title_X, Begin_Y , android_FontBigBoder);
		...
		//	mainCanvas.drawText(" "+(UserInfo.myUserInfo.level),LEVEL_X,(int)( Begin_Y +  (1 + (6 +2)*1.5)*textBoundsNormal.height()), android_FontNormal);
			...
			if (CandyPop.isTouchDrapInRect(0, 0, DEF.BUTTON_CANCEL_CONFIRM_W, DEF.BUTTON_CANCEL_CONFIRM_H))
				StateGameplay.spriteDPad.drawAFrame(CandyPop.mainCanvas, DEF.FRAME_CANCEL_HIGHTLIGHT, 0, 0);
			else
				StateGameplay.spriteDPad.drawAFrame(CandyPop.mainCanvas, DEF.FRAME_CANCEL_NORMAL, 0, 0);
