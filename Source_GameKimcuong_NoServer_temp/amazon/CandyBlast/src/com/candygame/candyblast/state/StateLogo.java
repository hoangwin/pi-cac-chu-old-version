...
import com.candygame.candyblast.Map;
import com.candygame.candyblast.SoundManager;
import com.candygame.candyblast.Sprite;
...
public class StateLogo extends CandyPop implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			case 1:
				...
				break;
			case 2:
				if (CandyPop.fontbig_White == null)
					CandyPop.fontbig_White = new BitmapFont("font/white_36.spr", true);				
				...
				android_FontSmallBoder.setColor(Color.rgb(188, 127, 197));
			...
			case 4:
				...
				SoundManager.initSounds(CandyPop.context);
				SoundManager.loadSounds();
				break;
			case 6:
				if (StateMainMenu.splashBitmap == null)
				{
					StateMainMenu.splashBitmap =  loadImageNoALphaFromAsset("image/splash.jpg",SCREEN_WIDTH,SCREEN_HEIGHT);
					//StateMainMenu.splashBitmap = loadImageFromAsset("image/splash.jpg");
					//StateMainMenu.splashBitmap = Bitmap.createScaledBitmap(StateMainMenu.splashBitmap, SCREEN_WIDTH, SCREEN_HEIGHT, false);
				}
				break;
			case 8:
			...
			case 20:
				StateGameplay.backgroundImage =  loadImageNoALphaFromAsset("image/screen/screen1.jpg",SCREEN_WIDTH,SCREEN_HEIGHT);
				//StateGameplay.backgroundImage = loadImageFromAsset("image/screen/screen1.jpg");
				//StateGameplay.backgroundImage = Bitmap.createScaledBitmap(StateGameplay.backgroundImage, SCREEN_WIDTH, SCREEN_HEIGHT, false);
				break;
			default:
				break;
			}
