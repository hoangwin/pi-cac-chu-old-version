...
public class StateMainMenu extends CandyPop implements IConstant
{
	...
	public static int[] arrayMenu = { MENU_TIME_TRIAL_MODE,MENU_CHALLENGE_MODE};
	public static String[] arrayMenuString = {"Classic","Challenge", };
		...
		case MESSAGE_UPDATE:
			...
			for (int i = 0; i < arrayMenu.length; i++) {
				...
				if (isTouchReleaseInRect(MENU_BEGIN_X - MENU_ELEMENT_W / 2, y - MENU_ELEMENT_H / 2, MENU_ELEMENT_W, MENU_ELEMENT_H)) {
					...
					case MENU_RATING:
						try {
							Uri uri = Uri.parse("market://details?id=com.mobilepuzzle.candypop");
