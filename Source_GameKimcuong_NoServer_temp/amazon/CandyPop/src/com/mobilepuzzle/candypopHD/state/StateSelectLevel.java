...
public class StateSelectLevel extends CandyPop
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			for (int i = 0; i < NUM_ROW; i++) {
				...
				for (int j = 0; j < NUM_COL; j++) {
					...
					if (CandyPop.mcurrentlevel <= CandyPop.mLevelUnlock) {
						...
						mainCanvas.drawText(" " + (mcurrentlevel +1)+ " ", x, y + textBounds.height()/2 , android_FontNormalBoder);
						mainCanvas.drawText(" " + (mcurrentlevel +1)+ " ", x, y + textBounds.height()/2 , android_FontNormal);
						...
						{
							mainCanvas.drawText( "New", x, y+ 3 * textBounds.height()/2 , android_FontNormalBoder);
			...
			mainCanvas.drawText( "SELECT LEVEL", SCREEN_WIDTH / 2, textBounds.height(), android_FontNormalBoder);
