...
public class SoundManager {
	...
	private static Context mContext;
	 ...
	 public static int SOUND_COMBOL_5 = 8;
	 public static int SOUND_WIN = 9;
	 public static int SOUND_LOSE = 10;
	 public static int SOUND_BACK = 11;
	...
	public static  void initSounds(Context theContext)
	{
	    ...
	    // mMediaPlayer = new MediaPlayer();	     
	     ...
	     try {
	    	 ...
	    	 mMediaPlayer[0] = MediaPlayer.create(ChristmasActivity.context,R.raw.m_title);
	    	 mMediaPlayer[1] = MediaPlayer.create(ChristmasActivity.context, R.raw.game_background);
	...
	{
		if(!ChristmasActivity.isEnableSound)
			return;
	...
	{	
		mSoundPoolMap.put(SOUND_SELECT, mSoundPool.load(mContext, R.raw.sound_back, 1));	
		...
		mSoundPoolMap.put(SOUND_COMBOL_5, mSoundPool.load(mContext,R.raw.combo_5, 1));
		...
		mSoundPoolMap.put(SOUND_BACK, mSoundPool.load(mContext, R.raw.sound_back, 1));
	}
