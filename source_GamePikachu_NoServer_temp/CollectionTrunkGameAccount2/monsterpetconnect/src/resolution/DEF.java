...
public class DEF
{
	...
	public static int FRAME_BUTTON_BACK_NORMAL = 6;
	public static int FRAME_BUTTON_BACK_HIGHTLIGHT = 7;
	...
	public static int FRAME_QUIT_NORMAL = 20;
	public static int FRAME_QUIT_HIGHTLIGHT = 21;
	...
	public static int FRAME_BUTTON_INFO_HIGHTLIGHT = 43;
	public static int FRAME_BUTTON_INFO_NORMAL = 44;
...
//	public static int offset = -100;
	...
	public static int BUTTON_HINT_X = (int)(MonsterActivity.scaleX*460); ; 
	public static int BUTTON_HINT_Y = (int)(MonsterActivity.scaleY*5); ;
	public static int BUTTON_HINT_W = 100; 
	public static int BUTTON_HINT_H = 100;
	
	public static int BUTTON_CHANGE_TILE_X = (int)(MonsterActivity.scaleX*580); 
	public static int BUTTON_CHANGE_TILE_Y = (int)(MonsterActivity.scaleY*5); 
	public static int BUTTON_CHANGE_TILE_W = 100; 
	public static int BUTTON_CHANGE_TILE_H = 100;
	
	public static int LABEL_LEVEL_X = (int)(MonsterActivity.scaleX*55); 
	...
	public static int HOWTOPLAY_BACKGROUND_W = MonsterActivity.SCREEN_WIDTH ;
	public static int HOWTOPLAY_BACKGROUND_H = MonsterActivity.SCREEN_HEIGHT;
	public static int HOWTOPLAY_BUTTON_W = 93;
	public static int HOWTOPLAY_BUTTON_H = 93;	
	public static int HOWTOPLAY_TITLE_X = MonsterActivity.SCREEN_WIDTH/2; 
	...
	public static int CREADIT_BACKGROUND_X = MonsterActivity.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_Y = MonsterActivity.SCREEN_HEIGHT /6;
	public static int CREADIT_BACKGROUND_W = MonsterActivity.SCREEN_WIDTH - 2 * MonsterActivity.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_H = MonsterActivity.SCREEN_HEIGHT - 2 * MonsterActivity.SCREEN_HEIGHT / 8;
	
	public static int CREADIT_TITLE_X = MonsterActivity.SCREEN_WIDTH/2; 
	...
	//align OPTION SCREEN
	public static int OPTION_TITLE_X = MonsterActivity.SCREEN_WIDTH/2; 
	...
	public static int SELECTLEVEL_BACKGROUND_W = MonsterActivity.SCREEN_WIDTH - 20;
	public static int SELECTLEVEL_BACKGROUND_H = MonsterActivity.SCREEN_HEIGHT - 20;
	public static int SELECTLEVEL_TITLE_X = MonsterActivity.SCREEN_WIDTH/2; 
	...
	public static int WINLOSE_BACKGROUND_W = MonsterActivity.SCREEN_WIDTH - 20;
	public static int WINLOSE_BACKGROUND_H = MonsterActivity.SCREEN_HEIGHT - 20;
	public static int WINLOSE_BUTTON_W = 93;
	public static int WINLOSE_BUTTON_H = 93;	
	public static int WINLOSE_TITLE_X = MonsterActivity.SCREEN_WIDTH/2; 
	public static int WINLOSE_TITLE_Y = WINLOSE_BACKGROUND_Y ;
	public static int WINLOSE_CONTENT_SPACE_H = 35;
	public static int WINLOSE_CONTENT_SPACE_W = 2*MonsterActivity.SCREEN_WIDTH/5;
	public static int WINLOSE_CONTENT_X = MonsterActivity.SCREEN_WIDTH/2; 
