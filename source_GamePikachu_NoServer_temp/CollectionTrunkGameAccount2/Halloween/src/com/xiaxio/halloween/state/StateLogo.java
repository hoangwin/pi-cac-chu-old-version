...
public class StateLogo extends HalloweenActivity implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			case 1:
				if (SCREEN_WIDTH > 700) {
					if (HalloweenActivity.fontsmall_White == null)
						HalloweenActivity.fontsmall_White = new BitmapFont("font/white_24.spr", true);
					if (HalloweenActivity.fontsmall_Yellow == null)
						HalloweenActivity.fontsmall_Yellow = new BitmapFont("font/yellow_24.spr", true);
					if (HalloweenActivity.fontbig_White == null)
						HalloweenActivity.fontbig_White = new BitmapFont("font/white_36.spr", true);
					if (HalloweenActivity.fontbig_Yellow == null)
						HalloweenActivity.fontbig_Yellow = new BitmapFont("font/yellow_36.spr", true);
				} else if (SCREEN_WIDTH > 300) { 
					if (HalloweenActivity.fontsmall_White == null)
						HalloweenActivity.fontsmall_White = new BitmapFont("font/white_big_400x240.spr", true);
					if (HalloweenActivity.fontsmall_Yellow == null)
						HalloweenActivity.fontsmall_Yellow = new BitmapFont("font/yellow_big_400x240.spr", true);
					if (HalloweenActivity.fontbig_White == null)
						HalloweenActivity.fontbig_White = new BitmapFont("font/white_big_400x240.spr", true);
					if (HalloweenActivity.fontbig_Yellow == null)
						HalloweenActivity.fontbig_Yellow = new BitmapFont("font/yellow_big_400x240.spr", true);
				}
				break;
			case 2:
				SoundManager.getInstance();
				SoundManager.initSounds(HalloweenActivity.context);
			...
			case 5:
				...
				if (StateHowToPlay.bitmapHowToplay == null) {
					StateHowToPlay.bitmapHowToplay = HalloweenActivity.loadImageFromAsset("image/howtoplay.png");
				}
				break;
		...
		case MESSAGE_PAINT:
			...
			HalloweenActivity.mainPaint.setColor(Color.WHITE);
			HalloweenActivity.mainPaint.setTextSize(20);
			matrix.reset();
