...
import com.xiaxio.halloween.GameThread;
...
import com.xiaxio.halloween.Sprite;
...
public class StateGameplay extends HalloweenActivity
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			if (HalloweenActivity.isTouchReleaseScreen()) {
				map.CardClick(HalloweenActivity.arraytouchPosX[0], HalloweenActivity.arraytouchPosY[0]);
		...
		case MESSAGE_PAINT:
			...
			matrix.postTranslate((SCREEN_WIDTH - backgroundImageSelectLevel.getWidth() * SCREEN_WIDTH / 1280) / 2, (SCREEN_HEIGHT - backgroundImageSelectLevel.getHeight() * SCREEN_HEIGHT / 800) / 2);
		...
		//	PikachuActivityHD.mainCanvas.drawRect(0, 0, PikachuActivityHD.SCREEN_WIDTH, PikachuActivityHD.SCREEN_HEIGHT, PikachuActivityHD.mainPaint);
			...
			HalloweenActivity.matrix.reset();
	...
	//	c.drawRect(0, 0, SCREEN_WIDTH, DEF.BUTTON_TIMER_BAR_H, mainPaint);
		...
		fontsmall_White.drawString(mainCanvas, "Level: " + (HalloweenActivity.mcurrentlevel +1), DEF.LABEL_LEVEL_X, DEF.LABEL_LEVEL_Y, BitmapFont.ALIGN_LEFT);
		...
		if (isTouchDrapInRect(DEF.BUTTON_IGM_X, DEF.BUTTON_IGM_Y, DEF.BUTTON_IGM_W, DEF.BUTTON_IGM_H))
			spriteDPad.drawAFrame(HalloweenActivity.mainCanvas, DEF.FRAME_PAUSE_HIGHTLIGHT, DEF.BUTTON_IGM_X, DEF.BUTTON_IGM_Y);
		else
			spriteDPad.drawAFrame(HalloweenActivity.mainCanvas, DEF.FRAME_PAUSE_NORMAL, DEF.BUTTON_IGM_X, DEF.BUTTON_IGM_Y);
		//hint
		if (isTouchDrapInRect(DEF.BUTTON_HINT_X, DEF.BUTTON_HINT_Y, DEF.BUTTON_HINT_W, DEF.BUTTON_HINT_H))
			spriteDPad.drawAFrame(HalloweenActivity.mainCanvas, DEF.FRAME_BUTTON_CUSTOM_HINT_HIGHTLIGHT, DEF.BUTTON_HINT_X, DEF.BUTTON_HINT_Y);
		else
			spriteDPad.drawAFrame(HalloweenActivity.mainCanvas, DEF.FRAME_BUTTON_CUSTOM_HINT, DEF.BUTTON_HINT_X, DEF.BUTTON_HINT_Y);
		...
		if (isTouchDrapInRect(DEF.BUTTON_CHANGE_TILE_X, DEF.BUTTON_CHANGE_TILE_Y, DEF.BUTTON_CHANGE_TILE_W, DEF.BUTTON_CHANGE_TILE_H))
			spriteDPad.drawAFrame(HalloweenActivity.mainCanvas, DEF.FRAME_BUTTON_CUSTOM_SORT_HIGHTLIGHT, DEF.BUTTON_CHANGE_TILE_X, DEF.BUTTON_CHANGE_TILE_Y);
		else
			spriteDPad.drawAFrame(HalloweenActivity.mainCanvas, DEF.FRAME_BUTTON_CUSTOM_SORT, DEF.BUTTON_CHANGE_TILE_X, DEF.BUTTON_CHANGE_TILE_Y);
		...
		//timer bar
		spriteDPad.drawAFrame(HalloweenActivity.mainCanvas, DEF.FRAME_TIMER_BAR_0, DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y);
		...
		HalloweenActivity.mainCanvas.save();
		HalloweenActivity.mainCanvas.clipRect(DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y, DEF.BUTTON_TIMER_BAR_X + (int) width, DEF.BUTTON_TIMER_BAR_Y + 32);
		spriteDPad.drawAFrame(HalloweenActivity.mainCanvas, DEF.FRAME_TIMER_BAR_1, DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y);
		HalloweenActivity.mainCanvas.restore();
