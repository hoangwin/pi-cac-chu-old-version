...
public class StateIngameMenu extends HalloweenActivity implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			HalloweenActivity.mainPaint.setColor(Color.argb(180,0, 0, 0));
			HalloweenActivity.mainCanvas.drawRoundRect(rectF, 25, 25, HalloweenActivity.mainPaint);
			for (int i = 0; i < arrayMenu.length; i++) {
				int y = MENU_BEGIN_Y + i * (MENU_ELEMENT_H + MENU_ELEMENT_SPACE);
