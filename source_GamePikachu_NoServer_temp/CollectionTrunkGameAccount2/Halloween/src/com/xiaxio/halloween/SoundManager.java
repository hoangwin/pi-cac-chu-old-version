...
public class SoundManager {
	...
	public static  void initSounds(Context theContext)
	{
	    ...
	    // mMediaPlayer = new MediaPlayer();	     
	     ...
	     try {
	    	 ...
	    	 mMediaPlayer[0] = MediaPlayer.create(HalloweenActivity.context,R.raw.m_title);
	    	 mMediaPlayer[1] = MediaPlayer.create(HalloweenActivity.context, R.raw.game_background);
	...
	{
		if(!HalloweenActivity.isEnableSound)
			return;
