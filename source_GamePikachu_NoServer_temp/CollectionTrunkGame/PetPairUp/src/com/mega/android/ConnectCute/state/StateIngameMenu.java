...
public class StateIngameMenu extends ConnectCute implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
			...
			for (int i = 0; i < arrayMenu.length; i++) {
				...
				if (isTouchReleaseInRect(MENU_BEGIN_X - MENU_ELEMENT_W / 2, y - MENU_ELEMENT_H / 2, MENU_ELEMENT_W, MENU_ELEMENT_H)) {
					...
					case MENU_BACK_TO_MAINMENU:
						Dialog.showDialog(Dialog.DIALOG_TYPE_CONFIRM, "", "BACK TO MAINMENU?", Dialog.DIALOG_BACK_TO_MAINMENU_EXIT);
						break;
					case MENU_EXIT:
		...
		case MESSAGE_PAINT:
			...
			ConnectCute.mainPaint.setARGB(150, 0, 0, 0);
			...
			ConnectCute.mainPaint.setColor(Color.argb(180,0, 0, 0));
			ConnectCute.mainCanvas.drawRoundRect(rectF, 25, 25, ConnectCute.mainPaint);
