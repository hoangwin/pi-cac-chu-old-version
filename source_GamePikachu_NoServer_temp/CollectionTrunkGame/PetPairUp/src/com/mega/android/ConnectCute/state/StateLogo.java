...
public class StateLogo extends ConnectCute implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			case 1:
				...
				android_FontWhite.setTextSize((int)(80*scaleY));
				android_FontWhite.setColor(Color.RED);
				...
				android_FontYellow.setTextSize((int)(80*scaleY));
			...
			case 2:
				...
				SoundManager.initSounds(ConnectCute.context);
			...
			case 5:
				...
				if (StateHowToPlay.bitmapHowToplay == null) {
					StateHowToPlay.bitmapHowToplay = ConnectCute.loadImageFromAsset("image/howtoplay.png");
				}
				break;
			...
			case 6:
				...
				if (StateGameplay.spriteTileBoard == null)
					StateGameplay.spriteTileBoard = new Sprite("sprite/ui/animal_1280x800.sprite",true,ConnectCute.scaleX,ConnectCute.scaleY);
		...
		case MESSAGE_PAINT:
			...
			ConnectCute.mainPaint.setColor(Color.WHITE);
			ConnectCute.mainPaint.setTextSize(20);
			matrix.reset();
