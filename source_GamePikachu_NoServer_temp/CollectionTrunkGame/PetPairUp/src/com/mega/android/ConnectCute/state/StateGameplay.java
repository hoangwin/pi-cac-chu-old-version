...
import com.mega.android.ConnectCute.GameThread;
...
import com.mega.android.ConnectCute.Sprite;
...
public class StateGameplay extends ConnectCute
{	
	...
	{	
		...
		case MESSAGE_UPDATE:
			...
			if (ConnectCute.isTouchReleaseScreen()) {
				map.CardClick(ConnectCute.arraytouchPosX[0], ConnectCute.arraytouchPosY[0]);
	...
	public static void drawHUD(Canvas c)
	{
		...
		mainCanvas.drawText("Level: " + (ConnectCute.mcurrentlevel +1) ,DEF.LABEL_LEVEL_X, DEF.LABEL_LEVEL_Y, android_FontWhite);
		android_FontWhite.setTextAlign(Align.RIGHT);
		mainCanvas.drawText("Score: " + Map.mAllScore,DEF.LABEL_SCORE_X, DEF.LABEL_SCORE_Y, ConnectCute.android_FontWhite);
		...
		if (isTouchDrapInRect(DEF.BUTTON_IGM_X, DEF.BUTTON_IGM_Y, DEF.BUTTON_IGM_W, DEF.BUTTON_IGM_H))
			spriteDPad.drawAFrame(ConnectCute.mainCanvas, DEF.FRAME_PAUSE_HIGHTLIGHT, DEF.BUTTON_IGM_X, DEF.BUTTON_IGM_Y);
		else
			spriteDPad.drawAFrame(ConnectCute.mainCanvas, DEF.FRAME_PAUSE_NORMAL, DEF.BUTTON_IGM_X, DEF.BUTTON_IGM_Y);
		//hint
		if (isTouchDrapInRect(DEF.BUTTON_HINT_X, DEF.BUTTON_HINT_Y, DEF.BUTTON_HINT_W, DEF.BUTTON_HINT_H))
			spriteDPad.drawAFrame(ConnectCute.mainCanvas, DEF.FRAME_BUTTON_CUSTOM_HINT_HIGHTLIGHT, DEF.BUTTON_HINT_X, DEF.BUTTON_HINT_Y);
		else
			spriteDPad.drawAFrame(ConnectCute.mainCanvas, DEF.FRAME_BUTTON_CUSTOM_HINT, DEF.BUTTON_HINT_X, DEF.BUTTON_HINT_Y);
		...
		mainCanvas.drawText( "(" + Map.countHint + ")", DEF.BUTTON_HINT_X + DEF.BUTTON_HINT_W / 2, DEF.BUTTON_HINT_Y + DEF.BUTTON_HINT_H/2 + (int)(0*scaleY), ConnectCute.android_FontWhite);
		// change title

		if (isTouchDrapInRect(DEF.BUTTON_CHANGE_TILE_X, DEF.BUTTON_CHANGE_TILE_Y, DEF.BUTTON_CHANGE_TILE_W, DEF.BUTTON_CHANGE_TILE_H))
			spriteDPad.drawAFrame(ConnectCute.mainCanvas, DEF.FRAME_BUTTON_CUSTOM_SORT_HIGHTLIGHT, DEF.BUTTON_CHANGE_TILE_X, DEF.BUTTON_CHANGE_TILE_Y);
		else
			spriteDPad.drawAFrame(ConnectCute.mainCanvas, DEF.FRAME_BUTTON_CUSTOM_SORT, DEF.BUTTON_CHANGE_TILE_X, DEF.BUTTON_CHANGE_TILE_Y);
		...
		mainCanvas.drawText( "(" + Map.countAutoSort + ")", DEF.BUTTON_CHANGE_TILE_X + DEF.BUTTON_CHANGE_TILE_W / 2, DEF.BUTTON_CHANGE_TILE_Y  + DEF.BUTTON_HINT_H/2 + (int)(0*scaleY),android_FontWhite);

		//timer bar
		spriteDPad.drawAFrame(ConnectCute.mainCanvas, DEF.FRAME_TIMER_BAR_0, DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y);
		...
		ConnectCute.mainCanvas.save();
		ConnectCute.mainCanvas.clipRect(DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y, DEF.BUTTON_TIMER_BAR_X + (int) width, DEF.BUTTON_TIMER_BAR_Y + 32);
		spriteDPad.drawAFrame(ConnectCute.mainCanvas, DEF.FRAME_TIMER_BAR_1, DEF.BUTTON_TIMER_BAR_X, DEF.BUTTON_TIMER_BAR_Y);
		ConnectCute.mainCanvas.restore();
