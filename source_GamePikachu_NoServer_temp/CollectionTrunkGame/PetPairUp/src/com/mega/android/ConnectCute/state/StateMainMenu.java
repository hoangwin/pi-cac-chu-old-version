...
public class StateMainMenu extends ConnectCute implements IConstant
{
	...
	public static int[] arrayMenu = { MENU_PLAY, MENU_HOW_PLAY  };
	public static String[] arrayMenuString = { "PLAY", "HOW TO PLAY"};
