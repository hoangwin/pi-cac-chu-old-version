...
public class StateIngameMenu extends AnimalActivity implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			//PikachuActivity.mainPaint.setARGB(150, 0, 0, 0);
			...
			AnimalActivity.mainCanvas.drawRect(0, 0, SCREEN_WIDTH,SCREEN_HEIGHT, AnimalActivity.mainPaint);
			for (int i = 0; i < arrayMenu.length; i++) {
				int y = MENU_BEGIN_Y + i * (MENU_ELEMENT_H + MENU_ELEMENT_SPACE);
