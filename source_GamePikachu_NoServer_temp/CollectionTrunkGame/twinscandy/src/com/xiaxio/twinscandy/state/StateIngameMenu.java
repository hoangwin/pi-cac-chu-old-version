...
public class StateIngameMenu extends TwinsCandy implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			TwinsCandy.mainPaint.setARGB(150, 0, 0, 0);
			...
			TwinsCandy.mainPaint.setColor(Color.argb(180,0, 0, 0));
			TwinsCandy.mainCanvas.drawRect(0, 0, TwinsCandy.SCREEN_WIDTH, TwinsCandy.SCREEN_HEIGHT, TwinsCandy.mainPaint);
			for (int i = 0; i < arrayMenu.length; i++) {
				int y = MENU_BEGIN_Y + i * (MENU_ELEMENT_H + MENU_ELEMENT_SPACE);
