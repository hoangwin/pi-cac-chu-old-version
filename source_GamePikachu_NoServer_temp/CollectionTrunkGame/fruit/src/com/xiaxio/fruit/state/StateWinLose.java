...
public class StateWinLose extends FruitLink
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		{
		case MESSAGE_CTOR:
			DEF.WINLOSE_CONTENT_SPACE_H = (int)(50*scaleY);//fontsmall_White.getFontHeight();
			if (isWin) {
				totalScore = (int) (Map.mcountAllPaired * 10 + Map.mAllScoreBonus + (Map.mTimerDecrease - Map.mTimerCount) / 200);
				FruitLink.mLevelUnlock++;
				FruitLink.mainActivity.saveGame();
			}
			...
			if (SCREEN_WIDTH > 480)
				DEF.WINLOSE_CONTENT_Y = DEF.WINLOSE_TITLE_Y + 2 *(int)(50*scaleY);//FruitLink.fontbig_Yellow.getFontHeight();
			else
				DEF.WINLOSE_CONTENT_Y = DEF.WINLOSE_TITLE_Y + 3 *(int)(50*scaleY);// FruitLink.fontbig_Yellow.getFontHeight();
		...
		case MESSAGE_UPDATE:
			...
			if (FruitLink.isTouchReleaseInRect(DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
				changeState(STATE_GAMEPLAY);

			if (isKeyReleased(KeyEvent.KEYCODE_BACK) || FruitLink.isTouchReleaseInRect(DEF.WINLOSE_BUTTON_X2, DEF.WINLOSE_BUTTON_Y2, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
				changeState(STATE_MAINMENU);
			if (isWin)
				if (FruitLink.isTouchReleaseInRect(DEF.WINLOSE_BUTTON_X3, DEF.WINLOSE_BUTTON_Y3, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H)) {
					FruitLink.mcurrentlevel++;
					changeState(STATE_GAMEPLAY);
				}
		...
		case MESSAGE_PAINT:
			...
			FruitLink.mainPaint.setARGB(210, 0, 0, 0);
			FruitLink.mainCanvas.drawRect(0, 0, FruitLink.SCREEN_WIDTH, FruitLink.SCREEN_HEIGHT, FruitLink.mainPaint);
			...
			if (!isWin) {
				...
				if (totalScore < 450)
					StateGameplay.spriteDPad.drawAFrame(FruitLink.mainCanvas, DEF.FRAME_START_1, DEF.WINLOSE_TITLE_X, DEF.WINLOSE_TITLE_Y + DEF.WINLOSE_CONTENT_SPACE_H);
				else if (totalScore < 550)
					StateGameplay.spriteDPad.drawAFrame(FruitLink.mainCanvas, DEF.FRAME_START_2, DEF.WINLOSE_TITLE_X, DEF.WINLOSE_TITLE_Y +  DEF.WINLOSE_CONTENT_SPACE_H);
				else
					StateGameplay.spriteDPad.drawAFrame(FruitLink.mainCanvas, DEF.FRAME_START_3, DEF.WINLOSE_TITLE_X, DEF.WINLOSE_TITLE_Y +  DEF.WINLOSE_CONTENT_SPACE_H);
			}
			...
			if (FruitLink.isTouchDrapInRect(DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
				StateGameplay.spriteDPad.drawAFrame(FruitLink.mainCanvas, DEF.FRAME_RETRY_NORMAL, DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1);
			else
				StateGameplay.spriteDPad.drawAFrame(FruitLink.mainCanvas, DEF.FRAME_RETRY_HIGHTLIGHT, DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1);

			if (FruitLink.isTouchDrapInRect(DEF.WINLOSE_BUTTON_X2, DEF.WINLOSE_BUTTON_Y2, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
				StateGameplay.spriteDPad.drawAFrame(FruitLink.mainCanvas, DEF.FRAME_MAINMENU_NORMAL, DEF.WINLOSE_BUTTON_X2, DEF.WINLOSE_BUTTON_Y2);
			else
				StateGameplay.spriteDPad.drawAFrame(FruitLink.mainCanvas, DEF.FRAME_MAINMENU_HIGHTLIGHT, DEF.WINLOSE_BUTTON_X2, DEF.WINLOSE_BUTTON_Y2);

			if (isWin) {
				if (FruitLink.isTouchDrapInRect(DEF.WINLOSE_BUTTON_X3, DEF.WINLOSE_BUTTON_Y3, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
					StateGameplay.spriteDPad.drawAFrame(FruitLink.mainCanvas, DEF.FRAME_NEXT_NORMAL, DEF.WINLOSE_BUTTON_X3, DEF.WINLOSE_BUTTON_Y3);
				else
					StateGameplay.spriteDPad.drawAFrame(FruitLink.mainCanvas, DEF.FRAME_NEXT_NORMAL, DEF.WINLOSE_BUTTON_X3, DEF.WINLOSE_BUTTON_Y3);
			}
