...
public class StateIngameMenu extends FruitLink implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			FruitLink.mainPaint.setARGB(150, 0, 0, 0);
			...
			FruitLink.mainPaint.setColor(Color.argb(180,0, 0, 0));
			FruitLink.mainCanvas.drawRect(0, 0, FruitLink.SCREEN_WIDTH, FruitLink.SCREEN_HEIGHT, FruitLink.mainPaint);
