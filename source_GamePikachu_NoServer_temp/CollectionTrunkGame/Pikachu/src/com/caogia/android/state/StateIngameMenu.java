...
public class StateIngameMenu extends MainActivityHD implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			MainActivityHD.mainPaint.setColor(Color.argb(180,0, 0, 0));
			MainActivityHD.mainCanvas.drawRoundRect(rectF, 25, 25, MainActivityHD.mainPaint);
			for (int i = 0; i < arrayMenu.length; i++) {
				int y = MENU_BEGIN_Y + i * (MENU_ELEMENT_H + MENU_ELEMENT_SPACE);
