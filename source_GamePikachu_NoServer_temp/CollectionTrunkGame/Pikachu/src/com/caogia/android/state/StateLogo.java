...
public class StateLogo extends MainActivityHD implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			case 1:
				if (SCREEN_WIDTH > 700) {
					if (MainActivityHD.fontsmall_White == null)
						MainActivityHD.fontsmall_White = new BitmapFont("font/white_24.spr", true);
					if (MainActivityHD.fontsmall_Yellow == null)
						MainActivityHD.fontsmall_Yellow = new BitmapFont("font/yellow_24.spr", true);
					if (MainActivityHD.fontbig_White == null)
						MainActivityHD.fontbig_White = new BitmapFont("font/white_36.spr", true);
					if (MainActivityHD.fontbig_Yellow == null)
						MainActivityHD.fontbig_Yellow = new BitmapFont("font/yellow_36.spr", true);
				} else if (SCREEN_WIDTH > 300) { 
					if (MainActivityHD.fontsmall_White == null)
						MainActivityHD.fontsmall_White = new BitmapFont("font/white_big_400x240.spr", true);
					if (MainActivityHD.fontsmall_Yellow == null)
						MainActivityHD.fontsmall_Yellow = new BitmapFont("font/yellow_big_400x240.spr", true);
					if (MainActivityHD.fontbig_White == null)
						MainActivityHD.fontbig_White = new BitmapFont("font/white_big_400x240.spr", true);
					if (MainActivityHD.fontbig_Yellow == null)
						MainActivityHD.fontbig_Yellow = new BitmapFont("font/yellow_big_400x240.spr", true);
				}
				break;
			case 2:
				SoundManager.getInstance();
				SoundManager.initSounds(MainActivityHD.context);
			...
			case 3:
				...
				break;
			case 4:
				if (StateSelectLevel.backgroundImageSelectLevel == null)
					StateSelectLevel.backgroundImageSelectLevel = loadImageFromAsset("image/screen_1280x800.jpg");
				break;
			case 5:
				...
				if (StateHowToPlay.bitmapHowToplay == null) {
					StateHowToPlay.bitmapHowToplay = MainActivityHD.loadImageFromAsset("image/howtoplay.png");
				}
				break;
			...
			case 8://init all variable 
				...
				DEF.BUTTON_TIMER_BAR_X = SCREEN_WIDTH - (DEF.BUTTON_TIMER_BAR_W + fontsmall_Yellow.stringWidth("Level : 60") + DEF.DIALOG_BUTTON_CONFIRM_W / 2);
		...
		case MESSAGE_PAINT:
			...
			MainActivityHD.mainPaint.setColor(Color.WHITE);
			MainActivityHD.mainPaint.setTextSize(20);
			matrix.reset();
