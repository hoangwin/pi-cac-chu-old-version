...
public class StateMainMenu extends MainActivityHD implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_CTOR:
			...
			MENU_BEGIN_X = MENU_ELEMENT_W/2 + 50;
		...
		//	canvasScreenBuffer
			...
			matrix.postTranslate(SCREEN_WIDTH - gameTitleBitmap.getWidth()* SCREEN_WIDTH / 1280, 0);
