...
import com.caogia.android.state.StateCreadit;
import com.caogia.android.state.StateGameplay;
import com.caogia.android.state.StateHowToPlay;
import com.caogia.android.state.StateIngameMenu;
import com.caogia.android.state.StateLogo;
import com.caogia.android.state.StateMainMenu;
import com.caogia.android.state.StateSelectLevel;
...
public class MainActivityHD extends GameLib
{
	...
	public static MainActivityHD mainActivity;
	...
	//	10-14 01:11:41.250: I/Ads(1001): To get test ads on this device, call adRequest.addTestDevice("A5E4D10B9DD43396048C1F79524989DB");
		...
		FrameLayout.LayoutParams adsParams = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT, FrameLayout.LayoutParams.WRAP_CONTENT, android.view.Gravity.TOP | android.view.Gravity.LEFT);
		if(density >1)
		{
			adsParams.setMargins( -(int)((density -1)*320), -(int)((density -1)*50), 0, 0);
		}
		
		if(SCREEN_WIDTH <380){
			adsParams.setMargins( -160, -18, 0, 0);
		}
		else if(SCREEN_WIDTH <420){
			adsParams.setMargins( -120, -18, 0, 0);
		}else if(SCREEN_WIDTH <480){
			adsParams.setMargins(-100, -10,  0, 0);
		}
