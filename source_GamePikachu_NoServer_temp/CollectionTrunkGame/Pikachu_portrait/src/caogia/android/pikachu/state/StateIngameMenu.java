...
public class StateIngameMenu extends Pikachu implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			Pikachu.mainPaint.setARGB(150, 0, 0, 0);
			...
			Pikachu.mainPaint.setColor(Color.argb(180,0, 0, 0));
			Pikachu.mainCanvas.drawRoundRect(rectF, 25, 25, Pikachu.mainPaint);
			for (int i = 0; i < arrayMenu.length; i++) {
				int y = MENU_BEGIN_Y + i * (MENU_ELEMENT_H + MENU_ELEMENT_SPACE);
