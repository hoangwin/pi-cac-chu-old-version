...
import com.gameviet.ketnoitraicay.state.StateCreadit;
...
public class DEF
{
	...
	public static int FRAME_INFO_NORMAL = 43;
	public static int FRAME_INFO_HIGHTLIGHT = 44;
...
//	public static int offset = -100;
	...
	public static int HOWTOPLAY_BACKGROUND_W = NoiTraiCay.SCREEN_WIDTH ;
	public static int HOWTOPLAY_BACKGROUND_H = NoiTraiCay.SCREEN_HEIGHT;
	public static int HOWTOPLAY_BUTTON_W = 93;
	public static int HOWTOPLAY_BUTTON_H = 93;	
	public static int HOWTOPLAY_TITLE_X = NoiTraiCay.SCREEN_WIDTH/2; 
	...
	public static int CREADIT_BACKGROUND_X = NoiTraiCay.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_Y =0;
	public static int CREADIT_BACKGROUND_W = NoiTraiCay.SCREEN_WIDTH - 2 * NoiTraiCay.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_H = NoiTraiCay.SCREEN_HEIGHT - 2 * NoiTraiCay.SCREEN_HEIGHT / 8;
	
	public static int CREADIT_TITLE_X = NoiTraiCay.SCREEN_WIDTH/2; 
	public static int CREADIT_TITLE_Y = (int)(110*StateCreadit.scaleY);//CREADIT_BACKGROUND_Y + 3;
	public static int CREADIT_CONTENT_X = CREADIT_TITLE_X; 
	public static int CREADIT_CONTENT_Y =(int)(180*StateCreadit.scaleY);//;
	public static int CREADIT_CONTENT_SPACE_H = 40;
	//align OPTION SCREEN
	public static int OPTION_TITLE_X = NoiTraiCay.SCREEN_WIDTH/2; 
	...
	//align select level
	public static int SELECTLEVEL_BACKGROUND_X =  0;
	public static int SELECTLEVEL_BACKGROUND_Y = 00;
	public static int SELECTLEVEL_BACKGROUND_W = NoiTraiCay.SCREEN_WIDTH - 20;
	public static int SELECTLEVEL_BACKGROUND_H = NoiTraiCay.SCREEN_HEIGHT - 20;
	public static int SELECTLEVEL_TITLE_X = NoiTraiCay.SCREEN_WIDTH/2; 
	...
	public static int WINLOSE_BACKGROUND_W = NoiTraiCay.SCREEN_WIDTH - 20;
	public static int WINLOSE_BACKGROUND_H = NoiTraiCay.SCREEN_HEIGHT - 20;
	public static int WINLOSE_BUTTON_W = 93;
	public static int WINLOSE_BUTTON_H = 93;	
	public static int WINLOSE_TITLE_X = NoiTraiCay.SCREEN_WIDTH/2; 
	public static int WINLOSE_TITLE_Y = WINLOSE_BACKGROUND_Y ;
	public static int WINLOSE_CONTENT_SPACE_H = 35;
	public static int WINLOSE_CONTENT_SPACE_W = 2*NoiTraiCay.SCREEN_WIDTH/5;
	public static int WINLOSE_CONTENT_X = NoiTraiCay.SCREEN_WIDTH/2; 
