...
public class StateIngameMenu extends NoiTraiCay implements IConstant
{
	...
	public static String[] arrayMenuString = { "VỀ GAME", "CHƠI LẠI", "ÂM THANH : ", "MENU CHÍNH", "THOÁT" };
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			NoiTraiCay.mainPaint.setARGB(210, 0, 0, 0);
